                ...
                <div class="card-body p-4 p-md-5">
                    <div class="alert alert-danger border-0 rounded-4 mb-4">
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                <h5 class="fw-bold mb-1">Peringatan!</h5>
                                <p class="mb-0">Jika Anda atau seseorang yang Anda kenal sedang dalam bahaya atau memikirkan untuk menyakiti diri sendiri, harap segera hubungi layanan darurat di bawah ini.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-column gap-3">
                        <div class="d-flex align-items-center justify-content-between p-4 bg-light rounded-4 border">
                            ...
                            <a href="tel:112" class="btn btn-danger rounded-pill px-4 fw-bold">112</a>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between p-4 bg-light rounded-4 border">
                            ...
                            <a href="tel:1500567" class="btn btn-danger rounded-pill px-4 fw-bold">1500-567</a>
                        </div>

                        <div class="d-flex align-items-center justify-content-between p-4 bg-light rounded-4 border">
                            <div class="d-flex align-items-center gap-3">
                                <div class="bg-white rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                    <i class="fa-solid fa-user-doctor text-danger fs-4"></i>
                                </div>
                                <div>
                            ...
                            <a href="tel:119" class="btn btn-danger rounded-pill px-4 fw-bold">119 (Ext 8)</a>
                        </div>
                    </div>
