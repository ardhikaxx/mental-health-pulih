...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-4">
        <div class="card border-0 p-4 shadow-sm h-100 d-flex flex-row align-items-center gap-3">
            @php
                $isBerat = strtolower($hasil->kategori_hasil) === 'berat' || strtolower($hasil->kategori_hasil) === 'tinggi';
            @endphp
            <div class="{{ $isBerat ? 'bg-danger text-danger' : 'bg-warning text-warning' }} bg-opacity-10 rounded-circle d-flex justify-content-center align-items-center flex-shrink-0" style="width: 60px; height: 60px;">
                <i class="fa-solid fa-chart-simple fs-3"></i>
            </div>
            <div>
                <small class="text-muted fw-semibold d-block mb-1">Kategori Hasil</small>
                <span class="badge {{ $isBerat ? 'bg-danger' : 'bg-warning' }} rounded-pill px-3 py-2 text-capitalize shadow-sm">
    ...
    <div class="col-md-4">
        <div class="card border-0 p-4 shadow-sm h-100 d-flex flex-row align-items-center gap-3" style="background-color: #f0fdf4;">
            <div class="bg-success bg-opacity-10 text-success rounded-circle d-flex justify-content-center align-items-center flex-shrink-0" style="width: 60px; height: 60px;">
                <i class="fa-solid fa-user-doctor fs-3"></i>
            </div>
            <div class="flex-grow-1">
                <small class="text-success fw-semibold d-block mb-2">Rekomendasi</small>
                <a href="{{ route('pasien.konsultasi.index') }}" class="btn btn-success w-100 fw-bold shadow-sm rounded-pill py-2 text-decoration-none">
...
<div class="row g-4">
    <div class="col-lg-5">
        <div class="card border-0 shadow-sm p-4 h-100 bg-info bg-opacity-10 border-start border-info border-4">
            <h5 class="fw-bold mb-3 text-info"><i class="fa-solid fa-circle-info me-2"></i> Keterangan Hasil</h5>
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm p-4 h-100">
            <h5 class="fw-bold mb-4 pb-3 border-bottom"><i class="fa-solid fa-list-check text-primary me-2"></i> Detail Jawaban Anda</h5>
