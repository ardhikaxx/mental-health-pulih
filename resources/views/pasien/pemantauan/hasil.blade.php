...
<section class="hero-panel d-flex justify-content-between align-items-center mb-4 p-4 bg-primary text-white rounded-4 position-relative overflow-hidden" style="background: linear-gradient(135deg, var(--primary-green), var(--secondary-green));">
    ...
    <div class="d-flex gap-2" style="position: relative; z-index: 2;">
        <a href="{{ route('pasien.pemantauan.riwayat') }}" class="btn btn-light bg-opacity-25 text-primary border-0 shadow-none fw-bold">
            <i class="fa-solid fa-clock-rotate-left me-1"></i> Riwayat
        </a>
        <a href="{{ route('pasien.dashboard') }}" class="btn btn-light bg-opacity-25 text-primary border-0 shadow-none fw-bold">
